  ...
  <div class="toolbarContainer" :class="{ isDark: isDark }">
    ...
    >
      ...
      <div class="toolbarBlock">
        ...
        <div class="toolbarBtn" v-if="IS_ELECTRON" @click="$bus.$emit('saveToLocal')">
          <span class="icon iconfont iconlingcunwei"></span>
      ...
      <div class="toolbarBlock">
        <div class="toolbarBtn" @click="$bus.$emit('showMindAi')">
          <span class="icon iconfont iconai"></span>
          <span class="text">{{ $t('toolbar.oneClickGeneration') }}</span>
        </div>
      </div>
    </div>
    <NodeImage></NodeImage>
